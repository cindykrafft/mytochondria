...
r2("gsea","GSEA-MSigDB","gsea-desktop","master",None,
   ...
   order_note="GS3 first: the default scoring scheme, silent, on a package 720 papers name (69 identify this program; the rest fgsea, clusterProfiler or unstated). GS1 follows once GS3 has an answer; GS2 after that (two-filing cap).")
