...
r2("gsea","GSEA-MSigDB","gsea-desktop","master",None,
   ...
   order_note="GS3 first: the default scoring scheme, silent, on the most-cited package audited (720 papers). GS1 follows once GS3 has an answer; GS2 after that (two-filing cap).")
...
ACTIONS=[
 ...
 dict(kind="issue", key="gsea", id="GS3", why="round 4's strongest finding, on the most-cited package audited so far (720 papers) and under the default scoring scheme: a gene set whose present members all score 0 gets a 0/0 hit weight, every running-sum comparison is false, and the set is reported with the running sum before its first hit as ES, plus NES, p and FDR of 0.000, no warning; 30 percent zeros in a 5000-gene list make a 40-gene all-zero set the second most negative result of the run"),
