...
in the audit link below, together with the output. The full test suite was
not run (it needs the datalad test-data checkout).

Found while working through open issues in a source-level correctness audit of research software (methods and harnesses: https://github.com/cindykrafft/research-software-audit/tree/main/audits/afni)
