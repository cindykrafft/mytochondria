...
| fieldtrip/fieldtrip | 5 PRs, 2 issues | #2613 merged 2026-09-04; #2610: the maintainer pushed two commits (his normalize denominator, extended test_ft_connectivity_psi) and asked for test_pull2610 to be removed and for a dpss_hack issue; #2609: his NaN-or-data question on the edge bins open; #2608, #2611, #2612 no comments; threads read in full on 2026-09-05 via a helper session | test_pull2610 removed (9af1fc4); his tests pass under Octave on 5e7e454; posted 2026-09-05: dpss issue #2614, reply on #2610 (cites #2614), reply on #2609 (keep the edge-bin values, or NaN both edges); waiting on the maintainer |
