...
| filed 2026-09-24 (#2707; branch on the fork, PR next) | STAR ST1 (+ST2, same patch) | a `.`-strand GTF feature makes `TranscriptomeSAM` write every read flag-inverted and reverse-complemented at the unchanged plus position (300/300 per strandless transcript, 0/300 on stranded ones), and stranded STARsolo counts such a gene's sense reads as 0; every version tested |
