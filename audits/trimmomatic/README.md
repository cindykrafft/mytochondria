...
| N2 | note, by reading with one executed symptom | Adapters of 24 nt and longer are seeded with every fourth 16-mer only (`INTERLEAVE = 4`), part of the 29 / 51 / 35 of 6,000 reads (thresholds 10 / 7 / 15) whose shipped clip differs from the documented sum, some of them adapters both references find. |
