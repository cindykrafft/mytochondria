...
Prepared 2026-09-13 against `alexdobin/STAR` `master` @ `b1edc12`. **Issue filed 2026-09-24 as #2707 and PR #2708 opened the same evening from
`fix/undefined-strand-transcripts` (`c444b28` on `b1edc12`, fork `cindykrafft/STAR`). Waiting for the maintainer.** The fix is one commit, `a0b3f8c`, on the local branch `fix/undefined-strand-transcripts`
