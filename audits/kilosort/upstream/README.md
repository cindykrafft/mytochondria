...
- 2026-09-24 (read 19:45Z via a helper session): kvnloo's second comment on PR #1043 (16:05Z): re-ran the unchanged `tests/test_swarmsplitter.py` from eabed49, all four pass on CPU, and the two expected failures reproduce with the base `swarmsplitter.py`; "this addresses the regression coverage I was suggesting". No question asked, no reply needed. Still no maintainer comment or review on any Kilosort filing; no check runs on the head commit.
- 2026-09-26 (watcher, 00:45Z): PR #1043 **merged** 2026-09-25 23:54 UTC (comment count unchanged at 3, so no maintainer text to read). PR #1045 and issues #1044, #1046, #1047 still have no response.
