...
report("KMeans cluster_centers_ = means of the assigned points", np.allclose(km.cluster_centers_, np.array([Xk[km.labels_ == j].mean(0) for j in range(4)]), atol=1e-9))
