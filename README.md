...
| [Seurat](audits/seurat/) | 767 | profiling pass done 2026-09-02 from the survey cache only (Europe PMC unreachable from that session; full-text rerun pending); seven audit targets ranked, differential expression first; component reviews not started | filing channel read (GitHub issues/PRs, wiki contributor's guide); nothing filed |
