...
| [AlphaFold 3](audits/alphafold3/) | 176 name AF3 (evidence-sentence level; Europe PMC unreachable for the full re-read) | 24 (22 verified by executing code, incl. a local build of the C++ extension), 2 more reproduced but already reported upstream and credited | 14 patches + 8 questions, filing kit ready |
